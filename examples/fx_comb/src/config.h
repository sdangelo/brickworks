...
#define P_TYPE				bw_example_fx_comb
#define P_INIT				bw_example_fx_comb_init
#define P_SET_SAMPLE_RATE		bw_example_fx_comb_set_sample_rate
#define P_MEM_REQ			bw_example_fx_comb_mem_req
#define P_MEM_SET			bw_example_fx_comb_mem_set
#define P_RESET				bw_example_fx_comb_reset
#define P_PROCESS			bw_example_fx_comb_process
#define P_SET_PARAMETER			bw_example_fx_comb_set_parameter
#define P_GET_PARAMETER			bw_example_fx_comb_get_parameter
