...
static struct config_parameter config_parameters[NUM_PARAMETERS] = {
	{ "Threshold", "Thresh", "", 0, 0, 0, 0.f },
	{ "Attenuation", "Attenuation", "%", 0, 0, 0, 0.f },
...
#define P_SET_PARAMETER			bw_example_fx_noise_gate_set_parameter
#define P_GET_PARAMETER			bw_example_fx_noise_gate_get_parameter
