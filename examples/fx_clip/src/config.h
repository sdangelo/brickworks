...
#define P_TYPE				bw_example_fx_clip
#define P_INIT				bw_example_fx_clip_init
#define P_SET_SAMPLE_RATE		bw_example_fx_clip_set_sample_rate
#define P_RESET				bw_example_fx_clip_reset
#define P_PROCESS			bw_example_fx_clip_process
#define P_SET_PARAMETER			bw_example_fx_clip_set_parameter
#define P_GET_PARAMETER			bw_example_fx_clip_get_parameter
